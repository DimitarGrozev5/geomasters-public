...
import AboutUsLandingVarna from "../components/page-components/index/about-us-landing-varna";
import SalesPitchVarna from "../components/page-components/index/sales-pitch-varna";
import bgImage from "../public/images/varna/varna1.jpg";
  ...
  return (
    <>
      <Head>
        <meta
          name="description"
          content="Геодезически услуги във Варна. Обеденили сме специалисти от цялата страна, за да решим вашия проблем."
        />
      </Head>
      <MainLanding city="Варна" backgroundImage={bgImage} />
      <Box
        sx={{
          width: "0.1%",
          height: "120vh",
